...
exports.default = {
    ...
    productValidation: (requestParamas, res, callback) => {
        const schema = joi_1.default.object({
            name: joi_1.default.string().trim().required(),
            ...
            stock: joi_1.default.string().trim().required(),
            offerprice: joi_1.default.string().trim().required()
        });
    ...
    categoryValidation: (requestParams, res, callback) => {
        const schema = joi_1.default.object({
            name: joi_1.default.string().trim().required()
        });
        const { error } = schema.validate(requestParams);
